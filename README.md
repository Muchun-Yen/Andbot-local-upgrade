...
In this document we descript how to make a Andbot system in SD card.
...
* It is used to recover or make an Andbot system SD card from a new SD card.
...
* Upgrade partition binary image.
	* It compresses Andbot rootfs partition to an image.
...
The upgrade partitions; the BOOT and trusty partitions diagram
